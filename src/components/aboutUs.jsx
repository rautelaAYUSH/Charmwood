    ...
    <Box sx={{ backgroundColor: '#F6F2E2' }} style={{height: '100vh', display: "flex"}}>
      <Grid container sx={{padding: '20px', alignItems: "center"}}>
        <Grid item xs={12} md={6} sx={{padding: '20px', height: "100%"}}>
          <Grid container sx={{padding: '20px', alignItems: "center"}}>
            <Grid item xs={12} md={6}>
              <img src="image (10).jpg" alt="Horse Riding 1" style={{ width: '90%', fill: 'cover', borderRadius: '10px' }} />
            </Grid>
            <Grid item xs={12} md={6}>
              <Grid container direction="column">
                <Grid item xs={12} md={6} sx={{padding: '10px'}}>
                  <img src="image (8).jpg" alt="Horse Riding 2" style={{ width: '100%', height: '40vh', borderRadius: '10px' }} />
                </Grid>
                <Grid item xs={12} md={6} sx={{padding: '10px'}}>
                  <img src="image (9).jpg" alt="Horse Riding 3" style={{ width: '100%', height: '40vh', borderRadius: '10px'  }} />
                </Grid>
              </Grid>
            </Grid>
          </Grid>
        ...
        <Grid item xs={12} md={6} sx={{padding: '20px', textAlign: "center"}}>
          ...
          <Typography variant="h5" sx={{marginTop: "2rem", color: '#757576'}} >
